...
def create_pagination_keyboard(category_id, page, has_next, name, price, status, lang='uz'):
    ...
    if status:
        keyboard.add(InlineKeyboardButton(text=language['order'], callback_data=f"category_{category_id}_order_{name}_{price}"))
    else:
